...
*5. Cell type annotation using PanglaoDB database (parameters: markers = ‘Lungs’, tmin=2). Further manual annotation for NA clusters (Day\_2 and Day\_3 timepoints) was performed based on marker gene expression.*
...
*Li J, Tang N. Alveolar stem cells in lung development and regrowth. In: Nikolić MZ, Hogan BLM, eds. Lung Stem Cells in Development, Health and Disease (ERS Monograph). Sheffield, European Respiratory Society, 2021; pp. 17–30 [[*https://doi.org/10.1183/2312508X.10009520*](https://doi.org/10.1183/2312508X.10009520)].*
